...
public class cBinomioTCP extends JFrame implements ActionListener{ //La clase cBinomioTCP se extiende de un JFrame e implementa la interfaz ActionListener
    ...
    /**
     *
     * El método con el que se configura la ventana. 
     * 
     */    
    ...
    /**
     *
     * En este método, se establecen las características de todos los elementos de la ventana, se agregan al contenedor, y se les agrega el método ActionListener. 
     * 
     */
    ...
    /**
     *
     * El método que permite ejecutar las acciones, dependiendo del botón que se oprima.
     * Las fucniones de cada boton estan comentadas en el código.
